...
$esxiuser = "root"
$esxipass = $env:ESXI_PASSWORD   # supply via environment; never store a password in this file
$VMHosts = "<esxi-host-fqdn-or-ip>"
$NTP1 = "0.pool.ntp.org"
$NTP2 = "1.pool.ntp.org"
$DNS1 = "<dns-server-1>"
$DNS2 = "<dns-server-2>"
$domainname = "example.com"   # set to the DNS domain of your ESXi hosts
